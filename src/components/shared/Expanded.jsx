...
const Expanded = ({ setExpand, imageIndex, setImageIndex, imageList }) => {
  ...
  return (
    <div className='fixed top-0 left-0 z-30 w-full h-full bg-contain backdrop-blur bg-black/30 flex justify-evenly items-center'>
      <img src={imageList[imageIndex]} className='max-w-screen max-h-full object-contain bg-no-repeat bg-center select-none cursor-cell'/>
