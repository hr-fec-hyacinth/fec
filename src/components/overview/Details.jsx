...
const Details = ({ product }) => {
  ...
  return (
    <div className='flex sm:flex-row flex-col mt-4 text-xl sm:text-sm'>
      <div className={product.slogan || product.description ? 'w-full sm:w-8/12 sm:border-r-[2px] border-slate-400 sm:text-left text-center sm:mb-0 mb-4 p-2 sm:pl-0 sm:pl-20 sm:pr-2' : 'hidden'}>
