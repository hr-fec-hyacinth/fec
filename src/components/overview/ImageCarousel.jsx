    ...
    <div className='hidden sm:block h-fit'>
      <div className='flex h-full flex-col left-4 absolute z-10'>
        ...
        {currentImages.map((image) => {
          return (
            <img alt='view_thumbnail' key={image.index} className={image.index === imageIndex ? 'border-b-[4px] border-blue-400 aspect-square object-cover w-12 select-none my-1' : 'aspect-square object-cover w-12 select-none my-1'} src={image.url} onClick={e => {
