    ...
    <>
      <div className='flex justify-center'>
        <div className='slider relative flex w-10/12'>
          {currentIndex > 0 &&
            <MdArrowBackIos className='flex-none back-arrow absolute left-12 top-2/4 z-20 cursor-pointer select-none hover:text-white' onClick={prevSlide} />
          }
          ...
          {currentIndex < length - 3 &&
            <MdArrowForwardIos className='flex-none forward-arrow absolute right-tenVH top-2/4 z-20 cursor-pointer select-none hover:text-white' onClick={nextSlide} />
          }
        </div>
      </div>
    </>
