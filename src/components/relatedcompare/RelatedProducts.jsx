      ...
      <div className='flex justify-center'>
        <div className='slider relative flex w-10/12'>
          ...
          {slides.map((slide, index) => (
            <RelatedProductsCard slide={slide} switchProduct={switchProduct} index={index} key={index} openModal={openModal} setOpenModal={setOpenModal} setCurrentCompare={setCurrentCompare} setCurrentIndex={setCurrentIndex} />
          ))}
        </div>
      </div>
    </>
